...
- Studia must show two immediately distinguishable choices on phones: Video Class and Quiz per capitolo. Preserve the complete Video Class landscape at its original ratio; never replace its left portion with a dark/blue panel or crop it to a portrait strip. Keep copy in the artwork's quiet left area, away from the face, with section-only headers and concise bilingual labels; verify at320/375px on web and native themes before handoff.
