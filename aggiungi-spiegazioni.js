...
function createAudioPlayer(question, { legacy = false } = {}) {
  ...
  const audio = new Audio(); audio.preload = "metadata"; let loading = null; let objectUrl = ""; let speedValue = 1; let speedStep = 0; const speedSteps = [1, 0.8, 1, 1.25, 1.5, 2]; let frame = 0; let seeking = false; let durationHint = 0; let sourceMode = ""; let blobFallbackTried = false;
