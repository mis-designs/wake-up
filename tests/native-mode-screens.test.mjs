...
test("ordinary browser initialization performs no native DOM mutation", () => {
  ...
  assert.ok(read("index.html").indexOf('android-mode-screens.js?v=2-thumb') < read("index.html").indexOf('script.js?v=79-headlight'));
});
...
test("native styles preserve the bounded grid, fallback, motion and ARIA contracts", () => {
  ...
  for (const asset of ["android-mode-screens.css?v=3-headlight","android-mode-screens.js?v=2-thumb","icons/native-chapter-clover.svg"]) assert.ok(read("service-worker.js").includes(asset));
