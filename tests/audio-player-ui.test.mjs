...
test("the shared player ships through the current PWA cache", () => {
  ...
  assert.match(studyPage, /audio-focus\.js\?v=1-resumable-tts[\s\S]*?study-quiz\.js\?v=32-video-class/u);
  assert.match(quizPage, /quiz\.js\?v=87-local-review/u);
  assert.match(studyPage, /study-quiz\.js\?v=32-video-class/u);
  assert.match(worker, /CACHE_NAME = "magicbook-pwa-v214-video-class"/u);
  ...
  assert.match(worker, /study-quiz\.js\?v=32-video-class/u);
});
