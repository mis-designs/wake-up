...
test("Quiz and Studia quiz load one shared Admin-derived player skin", () => {
  assert.ok(quizPage.indexOf("mystyle.css?v=52-focused-quiz") < quizPage.indexOf("audio-player-ui.css?v=7-compact-quiz"));
...
test("the shared player ships through the current PWA cache", () => {
  assert.match(quizPage, /audio-focus\.js\?v=1-resumable-tts[\s\S]*?quiz\.js\?v=83-focused-quiz/u);
  assert.match(studyPage, /audio-focus\.js\?v=1-resumable-tts[\s\S]*?study-quiz\.js\?v=26-intact-figures/u);
  assert.match(quizPage, /quiz\.js\?v=83-focused-quiz/u);
