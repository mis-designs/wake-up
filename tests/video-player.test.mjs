...
function playerFixture() {
  let instance;const calls={add:[],flush:0,changed:0,ready:0,failed:0,blocked:0};
  ...
  return {YT,calls,get instance(){return instance;},options:{frame:{},id:'abcdefghijk',store:{add(...a){calls.add.push(a);},flush(){calls.flush++;}},isCurrent:()=>true,changed(){calls.changed++;},ready(){calls.ready++;},failed(){calls.failed++;},blocked(){calls.blocked++;},loadAPI:()=>Promise.resolve(YT)}};
}
