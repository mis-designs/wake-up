...
test("leaving the admin panel restores the entry and ships the new script version", () => {
  ...
  assert.match(htmlSource, /script\.js\?v=31-bilingual-trial-promo/);
  assert.match(workerSource, /script\.js\?v=31-bilingual-trial-promo/);
  assert.match(workerSource, /CACHE_NAME = "magicbook-pwa-v62-bilingual-trial-promo"/);
});
