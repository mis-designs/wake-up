...
test("leaving the admin panel restores the entry and ships the new script version", () => {
  ...
  assert.match(htmlSource, /script\.js\?v=80-welcome/);
  assert.match(workerSource, /script\.js\?v=80-welcome/);
  assert.match(workerSource, /CACHE_NAME = "magicbook-pwa-v227-welcome-clean"/);
});
