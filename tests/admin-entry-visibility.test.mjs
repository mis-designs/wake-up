...
test("leaving the admin panel restores the entry and ships the new script version", () => {
  ...
  assert.match(htmlSource, /script\.js\?v=65-shared-gif-loader/);
  assert.match(workerSource, /script\.js\?v=65-shared-gif-loader/);
  assert.match(workerSource, /CACHE_NAME = "magicbook-pwa-v148-shared-gif-loader"/);
});
