...
test("leaving the admin panel restores the entry and ships the new script version", () => {
  ...
  assert.match(htmlSource, /script\.js\?v=76-shared-popup/);
  assert.match(workerSource, /script\.js\?v=76-shared-popup/);
  assert.match(workerSource, /CACHE_NAME = "magicbook-pwa-v204-figure-details"/);
});
