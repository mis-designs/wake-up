...
test("leaving the admin panel restores the entry and ships the new script version", () => {
  ...
  assert.match(htmlSource, /script\.js\?v=71-native-study/);
  assert.match(workerSource, /script\.js\?v=71-native-study/);
  assert.match(workerSource, /CACHE_NAME = "magicbook-pwa-v171-right-bilingual"/);
});
