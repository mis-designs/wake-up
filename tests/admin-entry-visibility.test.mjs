...
test("leaving the admin panel restores the entry and ships the new script version", () => {
  ...
  assert.match(htmlSource, /script\.js\?v=59-promo-code-return/);
  assert.match(workerSource, /script\.js\?v=59-promo-code-return/);
  assert.match(workerSource, /CACHE_NAME = "magicbook-pwa-v126-promo-code-return"/);
});
