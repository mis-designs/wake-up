...
test("leaving the admin panel restores the entry and ships the new script version", () => {
  ...
  assert.match(htmlSource, /script\.js\?v=48-free-trial-7d/);
  assert.match(workerSource, /script\.js\?v=48-free-trial-7d/);
  assert.match(workerSource, /CACHE_NAME = "magicbook-pwa-v101-home-actions-beside-promo"/);
});
