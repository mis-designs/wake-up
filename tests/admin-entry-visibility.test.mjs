...
test("leaving the admin panel restores the entry and ships the new script version", () => {
  ...
  assert.match(htmlSource, /script\.js\?v=46-promo-user-cap/);
  assert.match(workerSource, /script\.js\?v=46-promo-user-cap/);
  assert.match(workerSource, /CACHE_NAME = "magicbook-pwa-v93-explain-quiz-artwork"/);
});
