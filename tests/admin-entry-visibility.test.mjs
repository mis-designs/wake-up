...
test("leaving the admin panel restores the entry and ships the new script version", () => {
  ...
  assert.match(htmlSource, /script\.js\?v=47-whats-new-popup/);
  assert.match(workerSource, /script\.js\?v=47-whats-new-popup/);
  assert.match(workerSource, /CACHE_NAME = "magicbook-pwa-v95-whats-new-popup"/);
});
