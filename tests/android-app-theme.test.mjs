...
test("the app marker precedes styles; only the native study variant may follow the theme", () => {
  ...
  for (const page of pages) {
    ...
    const themeIndex = html.indexOf("/android-app-theme.css?v=8-login-sticker");
    ...
    const studyIndex = html.indexOf("/android-study-shell.css?v=16-matte-actions");
    if (page === "index.html") {
...
test("the app theme assets are available offline", () => {
  ...
  assert.match(worker, /\/android-app-theme\.css\?v=8-login-sticker/);
});
