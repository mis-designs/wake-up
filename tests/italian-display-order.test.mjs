...
test("quiz and study renderers use the shared Italian case owner", () => {
  ...
  assert.ok(quizPage.indexOf("italian-display.js?v=1") < quizPage.indexOf("quiz.js?v=76-italian-display-order"));
  assert.ok(studyPage.indexOf("italian-display.js?v=1") < studyPage.indexOf("study-quiz.js?v=22-user-study-order"));
