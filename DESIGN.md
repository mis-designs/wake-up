...
design_context:
  ...
  revision_notes: Replaced the Bengali study face with self-hosted Ekushey Lal Sabuj while retaining the established Italian UI typography and responsive study layout.
---
...
- Type: Inter/system sans for Italian UI. Study-mode Bengali glyphs use a self-hosted Ekushey Lal Sabuj 400 face limited to the Bengali Unicode range, then Noto Sans Bengali and Hind Siliguri as fallbacks; other catalog surfaces retain their established Bengali families.
