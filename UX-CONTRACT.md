...
| Android installed palette | `android-webview-mode.js`, `android-app-theme.css` | `html.android-webview` and `data-app-palette="aura-fluid"` | Aura purple chrome, lilac support surfaces, white reading canvas, dark ink, and sparse red signals; browser palette and semantic status colors remain unchanged | Early-marker order, route coverage, offline cache, scope, contrast, and reduced-motion tests |
